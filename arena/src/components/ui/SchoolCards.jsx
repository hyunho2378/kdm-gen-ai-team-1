  ...
  return (
    <button
      ...
      style={{
        ...
        border: `1px solid ${lit ? colors.accent.base : colors.line.default}`,
        background: colors.bg.raised,
        boxShadow: selected ? `0 0 16px ${colors.accent.glow}` : 'none',
      ...
      <span style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
        <span
          style={{
            ...
            fontWeight: 700,
            color: lit ? colors.accent.base : colors.text.dim,
            border: `1px solid ${lit ? colors.accent.base : colors.line.strong}`,
