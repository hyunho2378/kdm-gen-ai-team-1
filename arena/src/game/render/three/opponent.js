...
const IDLE = {
  ...
  hip: [[0.375, 0.548], [0.625, 0.548]],
  knee: [[0.258, 0.750], [0.742, 0.750]],
...
const POSES = {
  ...
  [POSE.ADVANCE]: pose({
    ...
    hip: [[0.362, 0.524], [0.612, 0.526]],
    knee: [[0.288, 0.700], [0.748, 0.740]],
  ...
  [POSE.TELEGRAPH]: pose({
    ...
    hip: [[0.382, 0.544], [0.632, 0.548]],
    knee: [[0.268, 0.750], [0.744, 0.752]],
  ...
  [POSE.HIT]: pose({
    ...
    hip: [[0.386, 0.548], [0.636, 0.542]],
    knee: [[0.286, 0.756], [0.744, 0.760]],
